...
<head>
    ...
    <title>Manajemen Buku - Backend System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="nav-grid">
            <a href="create.php" class="nav-card">
                ...
                <h2>Create Buku</h2>
                <p>Tambah buku baru ke dalam sistem</p>
            </a>

            <a href="read.php" class="nav-card">
                <span class="icon">📋</span>
                <h2>Read Buku</h2>
                <p>Lihat daftar semua buku yang tersedia</p>
            </a>

            <a href="update.php" class="nav-card">
                <span class="icon">✏️</span>
                <h2>Update Buku</h2>
                <p>Edit dan update data buku yang ada</p>
            </a>

            <a href="delete.php" class="nav-card">
                <span class="icon">🗑️</span>
                <h2>Delete Buku</h2>
                <p>Hapus buku dari sistem</p>
            </a>
        </div>
    </div>
</body>
